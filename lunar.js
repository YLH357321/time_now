/**
 * 农历日期计算模块
 * 提供 getLunarDate(date) 函数，返回农历日期字符串
 */
...
const solarDay = ['初一','初二','初三','初四','初五','初六','初七','初八','初九','初十',
 ...
 * @returns {string} 农历日期字符串，如 "甲辰年 正月十五"
 */
function getLunarDate(date) {
    ...
    return `${gan[(year - 4) % 10]}${zhi[(year - 4) % 12]}年 ${isLeap ? '闰' + solarMonth[m - 1] : solarMonth[m - 1]}${solarDay[offset]}`;
}